...
public class ServerThread extends Thread {
    ...
    private HashMap<String, ValueInformation> data = new HashMap<>();
    ...
    public synchronized void setData(String value, ValueInformation valueInformation) {
        this.data.put(value, valueInformation);
    }

    public synchronized HashMap<String, ValueInformation> getData() {
        return data;
    }
    ...
    // when the server thread is stopped, the server socket is closed
